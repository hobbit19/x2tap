...
namespace IniParser.Parser
{
    ...
    public class IniDataParser
    {
        ...
        protected virtual void ProcessSection(string line, IniData currentIniData)
        {
            ...
            var sectionName = Configuration.SectionRegex.Match(line).Value.Trim();
        ...
        protected virtual void ProcessKeyValuePair(string line, IniData currentIniData)
        {
            ...
            {
                if (!Configuration.AllowKeysWithoutSection) throw new ParsingException("key value pairs must be enclosed in a section");
        ...
        {
            var index = s.IndexOf(Configuration.KeyValueAssigmentChar, 0);
